  ...
  return (
    <Routes>
      ...
      <Route element={<AdminRoute />}>
        ...
        <Route path="/admin/quizzes/:id/import" element={<AIQuestionImport />} />

        <Route path="/admin/live-quizzes" element={<LiveQuizManagement />} />
        <Route path="/admin/live-quizzes/:id" element={<QuizDetail />} />
        <Route path="/admin/live-quizzes/:id/edit" element={<QuizForm />} />
        <Route
          path="/admin/live-quizzes/:id/import"
          element={<AIQuestionImport />}
        />
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route
          path="/student/live-quizzes/:id/attempt"
          element={<LiveQuizAttempt />}
        />
