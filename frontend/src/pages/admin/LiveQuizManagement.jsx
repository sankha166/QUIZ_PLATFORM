    ...
    <AdminLayout>
      <div className="min-w-0 space-y-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Create, publish, edit, delete and analyse live events from this
              section only.
            </p>
          </div>
          <Link
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
          <div className="card">
            <p className="text-xs text-slate-500">Total live attempts</p>
            <p className="mt-1 text-2xl font-bold">{stats.attempts || 0}</p>
          </div>
          <div className="card">
            <p className="text-xs text-slate-500">Average live rating</p>
        ...
        <section className="card overflow-hidden p-0">
          <div className="border-b p-4">
            ...
            <p className="text-sm text-slate-500">
              Normal quizzes never appear here, and live quizzes never appear in
              the normal quiz listing.
            </p>
          </div>
                ...
                {items.map((quiz) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3">
                        <span
                          className={`rounded-full px-2.5 py-1 text-xs font-bold ${status === "Live now" ? "bg-rose-100 text-rose-700" : status === "Upcoming" ? "bg-amber-100 text-amber-700" : status === "Completed" ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-600"}`}
                        >
                          {status}
                        </span>
                      </td>
        ...
        {selected && (
          ...
          >
            <div
              className="max-h-[90vh] w-full max-w-2xl overflow-auto rounded-3xl bg-white p-5 shadow-2xl sm:p-7"
