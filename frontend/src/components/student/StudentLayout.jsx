    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <aside className="absolute left-0 top-0 flex h-full w-[min(86vw,340px)] flex-col border-r border-slate-200 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-950">
